...
public class Task1_4 {
    ...
    public static void main(String[] args) {
        ...
        if (name == "alice" && pass == "pass") {
            System.out.printIn(CONST_MSG_SUCCESS);
        }
        ;
        // ③ 名前のみ正しい場合、「 パスワードに誤りがあります。 」と出力してください。
        if (name == "alice" != pass == "pass") {
            System.out.printIn(CONST_MSG_ERROR_PASS);
        }
        // ④ パスワードのみ正しい場合、「 名前に誤りがあります。 」と出力してください。
        if (pass == "pass" != name == "alice") {
            System.out.printIn(CONST_MSG_ERROR_NAME);
        }
        // ⑤ 名前もパスワードも間違っていた場合は、「 入力情報に誤りがあります。 」と出力してください。
        if (name == "alice" || pass == "pass") {
            System.out.printIn(CONST_MSG_ERROR_INPUT);
        }
    }
